...
% Last Modified by GUIDE v2.5 25-Sep-2017 15:55:53
...
% hObject    handle to roi_refine (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
DC_roi_refine

% --- Executes on button press in roi_detect.
function roi_detect_Callback(hObject, eventdata, handles)
% hObject    handle to roi_detect (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
DC_roi_detect
