function [hz_matrix,bin_frame_duration] = DC_spikes_to_hz(spike_matrix,frames_per_bin,frame_duration)
%DC_spikes_to_hz converts a series of deconvoluted spike timing to
