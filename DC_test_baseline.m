function DC_test_baseline(raw_traces,baselineframes,roiselect,max_pass)
...
DC_multiplot(dF,'pass_0',1,'frames',10,1:size(dF_active,2),dF_active,original_base,nan,nan);
...
%DC_multiplot(dF,'pass_final',1,'frames',10,1:size(dF_active,2),dF_active,dF_baseline,original_base,nan);
DC_multiplot(dF,'pass_final',1,'frames',10,1:size(dF_active,2),dF_active,dF_baseline,nan,nan);
