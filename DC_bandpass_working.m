function [filter_video] = DC_bandpass_working(video_file, cutoff_low,cutoff_high,confidence, save_row,name_rows,compression,rate)
...
% filtered=DC_bandpass_working(video_file, 0,1,0.99,0,'rows','none',4);
