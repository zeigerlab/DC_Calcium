function DC_multiplot(raw_traces,plots_per_page,filename,frame_length,x_units,x_tick_number,y_units,y_tick_number,roi_numbers,active_traces,baseline,threshold,stimulus)
